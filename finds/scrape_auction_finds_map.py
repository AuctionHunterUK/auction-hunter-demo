  ...
  <style>
    ...
    *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    @media (min-width: 801px) {{
      ...
      nav.jump .wanted-filter-button {{ min-height: 42px; font-size: .9375rem; font-weight: 600; padding: 8px 14px 8px 24px; color: #333; }}
      nav.jump .wanted-filter-button.active {{ border-radius: 2px; padding: 8px 14px 8px 24px; color: #fff; }}
      nav.jump .wanted-filter-button.active .jump-count {{ color: #fff; background: rgba(255,255,255,.18); }}
