  ...
  <style>
    ...
    *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    @media (min-width: 801px) {{
      ...
      .app-nav {{ border-radius: 2px; padding: 3px; background: #f5f5f5; border-color: #d2d2d2; }}
      .app-nav-link {{ border-radius: 0; font-size: .9375rem; padding: 10px 22px; }}
      .app-nav-link.on {{ box-shadow: none; }}
