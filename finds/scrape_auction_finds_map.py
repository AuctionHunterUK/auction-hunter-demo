  ...
  <style>
    ...
    *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    @media (min-width: 801px) {{
      ...
      .hrow2 {{ min-height: 64px; border-top: 1px solid #ececec; column-gap: 28px; }}
      .header-page-tools {{ display: flex; align-items: center; gap: 18px; }}
      header .tagline {{ display: none; }}
